...
class AttentionModel(nn.Module):
    ...
    def __init__(self, embed_dim=128, embed_dim_dec=256, n_encode_layers=3, n_heads=8, tanh_clipping=10., FF_hidden=512, veh_dim=64):
        super().__init__()

        self.Encoder = GraphAttentionEncoder(
            embed_dim, n_heads, n_encode_layers, FF_hidden)
        self.Decoder = DecoderCell(
            embed_dim, embed_dim_dec, veh_dim, n_heads, tanh_clipping)
