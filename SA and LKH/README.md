...
В данной таблице в качестве cost представлено среднее время в секундах по 100 примерам для 20, 50, 100 точек. Данное время включает в себя время ождидания открытия временного окна конкретного клиента.
